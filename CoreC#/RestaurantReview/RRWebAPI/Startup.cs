        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddCors(
                (builder) => {
                    ...
                    {
                        policy.WithOrigins("http://127.0.0.1:4200", "https://rrangular.azurewebsites.net", "https://52.152.190.230/", "http://52.152.190.230/") //This is where you state the address that you want to trust
